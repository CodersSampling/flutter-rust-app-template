...
//  source: messages/sample_module.proto
//
// @dart = 2.12
...
class OtherDummySchema extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OtherDummySchema', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'sample_module'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'some')
    ..hasRequiredFields = false
  ;

  OtherDummySchema._() : super();
  factory OtherDummySchema({
    $core.bool? some,
  }) {
    final _result = create();
    if (some != null) {
  ...
  factory OtherDummySchema.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory OtherDummySchema.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  OtherDummySchema clone() => OtherDummySchema()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OtherDummySchema copyWith(void Function(OtherDummySchema) updates) => super.copyWith((message) => updates(message as OtherDummySchema)) as OtherDummySchema; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static OtherDummySchema create() => OtherDummySchema._();
  OtherDummySchema createEmptyInstance() => create();
  static $pb.PbList<OtherDummySchema> createRepeated() => $pb.PbList<OtherDummySchema>();
  @$core.pragma('dart2js:noInline')
  static OtherDummySchema getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<OtherDummySchema>(create);
  static OtherDummySchema? _defaultInstance;
